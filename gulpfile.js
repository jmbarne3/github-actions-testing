...
//
// Series of tasks specific to linting/testing.
//
gulp.task('test', gulp.parallel('scss-lint', 'es-lint'));

//
// Series of tasks specific for building projects
//
gulp.task('build', gulp.parallel('scss-build-proj', 'js-build-global'));
